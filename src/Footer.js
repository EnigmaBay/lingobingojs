...
export default function Footer(props){
  ...
  return (
    <div data-theme={props.dataTheme} className='text-center themed-footer'>
      ...
      <p className='themed-footer-text-small' data-theme={props.dataTheme}><a className='themed-hyperlink' data-theme={props.dataTheme} href='http://icons8.com/'>This website makes use of icons by Icons8</a></p>
    </div>
  );
}
