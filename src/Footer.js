...
export default function Footer(props){
  ...
  return (
    <Card data-theme={props.dataTheme} className='text-center themed-footer'>
      <Card.Title className='themed-header'data-theme={props.dataTheme}>LingoBingoJS</Card.Title>
      <Card.Text className='themed-text' data-theme={props.dataTheme}>&#169; Copyright 2022 {enigmaBay}, the content on this website, of which {enigmaBay} is the author, is released under an {mit}.</Card.Text>
